...
static void ImGui_ImplWin32_AddKeyEvent(
    ImGuiIO & io,
    ImGuiKey key,
    bool down,
    int native_keycode,
    ...
    switch (msg)
    {
        ...
        case WM_XBUTTONDBLCLK:
        {
            ...
            if (bd->MouseButtonsDown == 0 && ::GetCapture() == nullptr)
                ::SetCapture(
                    hwnd); // Allow us to read mouse coordinates when dragging mouse outside of our window bounds.
        ...
        case WM_INPUTLANGCHANGE: ImGui_ImplWin32_UpdateKeyboardCodePage(io); return 0;
        case WM_CHAR:
...
#        pragma comment( \
            lib, \
            "gdi32") // Link with gdi32.lib for GetDeviceCaps(). MinGW will require linking with '-lgdi32'
#    endif
